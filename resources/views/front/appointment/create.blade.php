...
|
                   ...
                   <div class="m-auto" style="width: 500px;">
                         <form id="request" action="{{route('store-appointment')}}" method="POST" class="main_form">
                            @csrf
                 ...
                 <div class="col-md-12">
                    ...
                    <input onchange="showHours(this.value)" min="<?=date('Y-m-d', time())?>" id="date" class="contactus" type="date" name="date" >
                </div>
                ...
                <div class="col-md-12 mt-4">
                    <label for=""> نهاية الحجز:  <span id="end"></span> </label>
                </div>
